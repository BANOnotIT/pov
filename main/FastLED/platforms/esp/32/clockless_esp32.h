...
__attribute__ ((always_inline)) inline static uint32_t
...
#define _ESP_ADJ2 (0)
    ...
    template<int BITS>
    __attribute__ ((always_inline)) inline static void writeBits(register uint32_t &last_mark, register uint32_t b) {
        b = ~b;
        b <<= 24;
