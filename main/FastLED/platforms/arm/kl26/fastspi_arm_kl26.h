...
template<int VAL>
void getScalars(uint8_t &sppr, uint8_t &spr) {
    if (VAL > 4096) {
        sppr = 7;
        spr = 8;
    }
    ...
    static inline void enable_pins(void) __attribute__((always_inline)) {
        switch (_DATA_PIN) {
            case 0:
                ...
                break;
            case 1:
                CORE_PIN1_CONFIG = PORT_PCR_MUX(5);
                break;
            case 7:
                CORE_PIN7_CONFIG = PORT_PCR_MUX(2);
                break;
            case 8:
                CORE_PIN8_CONFIG = PORT_PCR_MUX(5);
                break;
            case 11:
                CORE_PIN11_CONFIG = PORT_PCR_MUX(2);
                break;
            case 12:
                CORE_PIN12_CONFIG = PORT_PCR_MUX(5);
                break;
            case 21:
...
public:
    ...
    inline static void writeBit(uint8_t b) { /* TODO */ }
